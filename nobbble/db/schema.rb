...
ActiveRecord::Schema.define(version: 20151015195100) do
  ...
  create_table "bscnenes", force: :cascade do |t|
    t.text     "content"
    t.integer  "projx_id"
    t.integer  "user_id"
    t.datetime "created_at", null: false
  ...
  add_index "bscnenes", ["projx_id"], name: "index_bscnenes_on_projx_id"
  add_index "bscnenes", ["user_id"], name: "index_bscnenes_on_user_id"
